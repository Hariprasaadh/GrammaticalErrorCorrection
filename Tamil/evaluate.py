"""
Tamil GEC Evaluation Script - Simplified Version
"""
...
if __name__ == "__main__":
    ...
    model_path = '../Models/tamil_gec_model/best_model'
    test_file = '../Dataset/tamil/dev.csv'
    output_file = 'evaluation_results.json'
    num_beams = 5
    
    print(f"Evaluating Tamil GEC Model")
