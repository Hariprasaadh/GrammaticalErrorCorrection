"""
Tamil GEC Inference Script - Simplified Version
"""
...
def interactive_mode(model_path, num_beams=5):
    ...
    print("\n" + "="*60)
    print("Tamil GEC Interactive Mode")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Tamil GEC Inference')
    parser.add_argument('--model_path', type=str, required=True, help='Path to trained model')
    parser.add_argument('--sentence', type=str, default=None, help='Single sentence to correct')
    parser.add_argument('--input_file', type=str, default=None, help='File with sentences (one per line)')
    parser.add_argument('--output_file', type=str, default=None, help='Output file for corrections')
    ...
    if args.interactive:
        interactive_mode(args.model_path, args.num_beams)
    elif args.sentence:
        correct_single(args.model_path, args.sentence, args.num_beams)
    elif args.input_file:
        correct_file(args.model_path, args.input_file, args.output_file, args.num_beams)
    else:
        parser.print_help()