...
def interactive_mode(model_path, num_beams=5):
    ...
    print("\n" + "="*60)
    print("Bangla GEC Interactive Mode")
    print("Type 'quit' or 'exit' to stop")
    print("="*60)
    
    while True:
        sentence = input("\nEnter Bangla sentence: ")
...
if __name__ == "__main__":
    ...
    model_path = '../Models/bangla_gec_mt5/best_model'
    
    print(f"Bangla GEC Inference (mT5-small)")
